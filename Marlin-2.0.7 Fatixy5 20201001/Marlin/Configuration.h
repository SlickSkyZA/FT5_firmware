...
#define STRING_CONFIG_H_AUTHOR "CareFudundae 20201001" // Who made the changes.
...
//#define CUSTOM_MACHINE_NAME "Fatixy5 SKR1.3"
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -3, 28, 0 }
